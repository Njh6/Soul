...
TOKEN = '7268436329:AAEkP0guDNKaSP8Rf1Dyuf1c5lWM2wlsTKE'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002105513298
CHANNEL_ID = -1002105513298
error_channel_id = -1002105513298
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/katilnoman", parse_mode='Markdown')
